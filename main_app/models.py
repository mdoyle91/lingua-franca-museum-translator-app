...
class Institution(models.Model):
    ...
    #I think I don't want the on delete Cascade here as that would eliminate the institution if I delete the user, and this is ideally going to be a many-to-many relationship. I will need to refactor this.
